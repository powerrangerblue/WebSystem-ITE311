...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="mb-1">Course Assignments</h1>
        <div class="text-muted small">View and submit assignments for this course</div>
    </div>
    <div>
        <a href="<?= base_url('dashboard') ?>" class="btn btn-outline-secondary me-2">Back to Dashboard</a>
        <a href="<?= base_url('courses') ?>" class="btn btn-outline-secondary">Browse Courses</a>
    </div>
</div>
    ...
    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-start">
                            <div class="flex-grow-1">
                                ...
                                <div class="d-flex gap-3 small text-muted mb-2">
                                    <span><i class="bi bi-calendar"></i> Due: <?= date('M j, Y \a\t g:i A', strtotime($assignment['due_date'])) ?></span>
                                    <?php if ($assignment['attachment']): ?>
                                        <span><i class="bi bi-paperclip"></i> Has attachment</span>
                                    <?php endif; ?>
                                </div>
        ...
        <?php else: ?>
            <div class="text-center py-5">
                ...
                <p class="text-muted">Your instructor hasn't created any assignments for this course yet.</p>
            </div>
        <?php endif; ?>
    </div>
</div>
